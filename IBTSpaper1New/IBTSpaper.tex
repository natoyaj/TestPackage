...
\end{tabular}
\caption[]{Estimated confidence intervals ($\mathrm{CI}_{96}$) from bias-corrected  bootstrap method for cod in years 2017 Q3 and 2018 Q1. Estimated indices of abundance (Estimate), and its standard error (SE), percentage relative standard error (RSE\%), and bootstrap mean (mean)  and median estimates are also given.}
