...
\centering
\begin{tabular}{@{}ccc@{}}
\subfloat[Map of IBTS Q1]{\includegraphics[width=1.0\textwidth]{surveyarea.pdf}} & 
...
%\includegraphics[width=103mm,scale=7.5]{latLon1058Skagen.png}
%\caption*{\bf (a) cod}
%\label{fig1.1}
%\end{minipage}
%
%\quad
%\begin{minipage}[c]{0.50\linewidth}
%\includegraphics[width=103mm,scale=7.5]{latLon059.png}
%\caption*{\bf (b) saithe}
%\label{fig5.1}
%\end{minipage}
