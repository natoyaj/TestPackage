...
\clearpage
%The methods of estimating abundance indices (\ref{abundanceestimatornorthsea}) and the uncertainty (\ref{sec:datrasstratifiedbootstrap}) around them are employed on IBTS data. 
...
\caption{Average estimates of abundance indices for the North Sea cod and saithe species from 500 bootstrap samples in years 2017-2018. Standard error estimates (SE) (relative standard error, RSE in parentheses) and the lower bounds (LB) and upper bounds (UP) of approximate $95\%$ confidence intervals from the three ALK methods are also given.}\label{resultstablecodandsaithe}}
