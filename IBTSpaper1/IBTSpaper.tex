...
\raisebox{1.5ex}{2017 Q3}& 0   & 1.698  & 0.36 ($21.2 \%$) & 0.815 & 2.200 & 1.699  & 0.35 ($21.6 \%$) &0.808 & 2.161 &  &  ($ \%$) \\[1ex]
& 1   & 15.478  & 2.66 ($17.2 \%$) & 10.734 & 19.923 & 15.549  & 2.61 ($16.8 \%$) &10.875 & 20.080 &  &  ($ \%$) \\[1ex]
& 2  & 1.903 & 0.36 ($18.9 \%$) & 1.306  & 2.668 & 1.792 & 0.25 ($14.0 \%$) &1.322 &2.237 & &  ($ \%$) \\[1ex]
& 3  & 1.310 & 0.15 ($11.5 \%$) & 1.024  & 1.543 & 1.307 & 0.13 ($9.9 \%$) &1.080 &1.558 & &  ($ \%$) \\[1ex]
& 4  &1.100  & 0.11 ($10.0 \%$) & 0.893  & 1.307 & 1.130 & 0.10 ($8.8 \%$) &0.881 &1.297 & &  ($ \%$) \\[1ex]
& 5  & 0.653 & 0.10 ($15.3 \%$) & 0.466  & 0.836 & 0.671 & 0.11 ($16.4 \%$) &0.440 &0.842 & &  ($ \%$) \\[1ex]
& 6+ & 0.286 & 0.05 ($17.5 \%$) & 0.202  & 0.384 & 0.280 & 0.02 ($7.1 \%$) &0.222 &0.318 & &  ($ \%$)\\[3.5ex]
...
\caption{Comparison of abundance estimates and uncertainty for cod and saithe  from DATRAS bootstrap procedure and stratified procedure using DATRAS ALK, in year 2017 Q3. Standard error estimates (SE) (relative standard error, RSE in parentheses) and the lower bounds (LB) and upper bounds (UP) of approximate $95\%$ confidence intervals from the three ALK methods are also given.}\label{resultstablecodandsaithe}}
\begin{tabular}{ccccccccccccccccccccccccccc}
\hline \\[0.1ex]
{\bf Species} &{\bf $a$ } & \multicolumn{4}{c}{\bf DATRAS bootstrap procedure} & \multicolumn{4}{c}{\thead{\bf Stratified bootstrap procedure}}  \\[1.5ex]
 % & \multicolumn{3}{c}{DATRAS Bootstrap}   & \multicolumn{3}{c}{Stratified Bootstrap}   & \multicolumn{3}{c}{Stratified Bootstrap} \\[1.5ex]
%   \cmidrule(lr{0.5em}){2-5}  \cmidrule(lr{0.1em}){6-9} \cmidrule(lr{0.5em}){10-13}  \\ [0.1ex]
& &$\widehat{mCPUE_{N,a}}$ & SE(RSE) & LB & UB &$\widehat{mCPUE_{N,a}}$ & SE (RSE) & LB & UB     \\[0.5ex]
\cmidrule(lr{0.5em}){3-6}  \cmidrule(lr{0.5em}){7-10}   \\ [0.1ex]
%\hline\\[1.0ex]
