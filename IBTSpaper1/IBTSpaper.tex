...
%The time needed for estimating the model varies slighlty between species and year. A laptop with  processor intel(R) Core(TM) i5-6300 CPU @ 2,40 GHz, used e.g. approximately 2 minutes to estimate the parameters for cod in year 2018.
...
\midrule
Trawl hauls  & Total of 372 trawl hauls in year 2018 Q1; 238 (83)  with length and 231 (82) \\ & with age information. In 2017 Q3, a total of 349 trawl hauls were taken; \\ & 238 (129) with length and 238 (129) with age information. \\[1.7ex]
...
Duration of haul & Mean duration is ..... minutes, with 30 minutes as ...\% coverage interval \\ & in year 2018 Q1; and in 2017 Q3 with mean duration of ....minutes \\ & with 30 minutes as ..... coverage . \\[1.7ex]
...
Total count for all ages & 1513 (794) in year 2018 Q1 and 2250 (2107) 2017 Q3. \\[0.5ex]
\bottomrule
\end{tabular}
\label{tab:data2018}
\end{table}
...
As discussed in Section \ref{sec:datrasstratifiedbootstrap} the naive bootstrap procedure proposed by DATRAS to estimate uncertainty around indices of abundance is not appropriate for IBTS survey. Firstly, the DATRAS bootstrap procedure ignores the fine-scale stratification in the sampling process, leading to an overestimation of the uncertainty. Secondly, it ignores sampling procedure of age-length data collected at the haul level, leading to an underestimation of the uncertainty. So there are biases in both direction. Table \ref{resultstablecodandsaitheAppendix} in Web appendix....., shows that an overestimation of the uncertainty around indices of abundance is overwhelming suggesting that it is highly relevant to account for the variation in the data over large areas. 

Table \ref{resultstablecodandsaithe} shows abundance indices, defined in (\ref{abundanceestimatornorthsea}), of cod and saithe estimated from each of the three ALK methods. Estimates of the standard error (SE), relative standard error (RSE in parentheses), the lower bound (LB) and upper bound (UB) of approximate $95 \%$ confidence intervals are also given from 200 bootstrap samples. For all ALK methods the stratified bootstrap procedure is employed to estimate the uncertainty around indices of abundance. {\bf The estimated indices of abundance of cod are similar for all ALKs, but the the spatial ALKs generally gave higher estimates. Also, the spatial ALKs provide a better fit to the data in terms of precision. Uncertainty estimates (RSE) for older fishes ($\ge 4$) are higher, as expected, for the spatial ALKs as fewer samples are generally collected for these, and given that spatial variation in the data is accounted for, variability would be higher.}
...
\raisebox{1.5ex}{2018 Q1} & 1   & 0.895  & 0.13 ($14.5 \%$) & 0.671 & 1.180 & 0.905  & 0.13 ($14.4 \%$) &0.712 & 1.206 &  &  ($ \%$) \\[1ex]
...
{\bf this table is to go in the appendix, after filling with correct values for SAITHE. It compares estimates of the DATRAS ALK and bootstrap procedure with estimates form DATRAS ALK method and stratified bootstrap procedure. The idea is to show that it is inappropriate to use DATRAS bootstrap procedure as it does not account for the fine-scale stratification in the survey design.}\\
\begin{tiny}
\begin{table}[h!]
\centering
\scriptsize
...
\raisebox{1.5ex}{2017 Q3} & 0& 0.744 &0.26 ($34.9 \%$) & 0.0326 & 1.154   &0.28 ($37.6 \%$) &0.340 &1.151 \\[1ex]
