...
\raisebox{1.5ex}{\bf cod 2017 Q3}& 0   & 1.698  & 0.36 ($21.2 \%$) & 0.815 & 2.200 & 1.699  & 0.35 ($21.6 \%$) &0.808 & 2.161 &  &  ($ \%$) \\[1ex]
...
\begin{itemize}
\item \emph{We can include a similar plot with 2017 (saithe) and 2018 (cod) data  here to show that it's reasonable to group at 2cm and 5 cm? }
\item \emph{Explain why 2 cm or 5 cm is chosen as illustrations?}
