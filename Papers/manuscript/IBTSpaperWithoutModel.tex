...
\end{enumerate}
\item Sample age observations from the resampled hauls obtained in step 1. We implement the following two procedure for this step. Again, the procedure (a) was suggested by \citep{ICES2006Report}, and is implemented for DATRAS bootstrap procedure and the modified-DATRAS bootstrap procedure. Procedure (b) is our suggestion for the stratified bootstrap procedure, which is intended to account for sampling design: 
\begin{enumerate}
