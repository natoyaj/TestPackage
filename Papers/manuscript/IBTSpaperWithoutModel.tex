...
\centering
\begin{tabular}{@{}ccc@{}}
\subfloat[cod in 2015-2018 Q1 ]{\includegraphics[width=0.55\textwidth]{figures/AgeTotalAllYearsQ3Cod.jpeg}}  
\subfloat[cod in 2015-2018 Q3 ]{\includegraphics[width=0.55\textwidth]{figures/AgeTotalAllYearsQ3Cod.jpeg}}  & \\
%\subfloat[cod in year 2017 Q1]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulEstimates2017Q1.jpeg}} & 
%\subfloat[cod in year 2018 Q1]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulEstimates2018Q1.jpeg}} & 
\end{tabular}
\caption[]{Number per age sampled of the North Sea cod and saithe in 2015-2018. }
\label{AgeTotalAllYearsQ3}
\end{figure*} 
...
\centering
\begin{tabular}{@{}ccc@{}}
\subfloat[cod in year 2015 Q1 ]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulEstimates2015Q1.jpeg}} & 
\subfloat[cod in year 2016 Q1 ]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulEstimates2016Q1.jpeg}} & \\
\subfloat[cod in year 2017 Q1]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulEstimates2017Q1.jpeg}} & 
\subfloat[cod in year 2018 Q1]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulEstimates2018Q1.jpeg}} & 
\end{tabular}
\caption[]{Estimated abundance at age for North Sea cod for the two ALK estimators based on data from the International Bottom Trawl Survey in 2015-2018 in the first quarter (Q1). The error bars are estimated 95\% confidence intervals using the bias corrected (see Methods) and 200 bootstrap samples. The age of cod ranged from $1$ to $6+$ in the first quarter and $0$ to $6+$ in the third quarter, where $6+$ is the "plus group consisting of all fish of age $6$ and older.  }
\label{AreaHaulEstimatesAllYearsQ1}
\end{figure*} 
...
\centering
\begin{tabular}{@{}ccc@{}}
\subfloat[saithe in year 2015 Q3 ]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulEstimates2015Q3.jpeg}} & 
\subfloat[saithe in year 2016 Q3 ]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulEstimates2016Q3.jpeg}} & \\
\subfloat[saithe in year 2017 Q3]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulEstimates2017Q3.jpeg}} & 
\subfloat[saithe in year 2018 Q3]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulEstimates2018Q3.jpeg}} & 
\end{tabular}
\caption[]{Estimated abundance at age for North Sea saithe for the two ALK estimators based on data from the International Bottom Trawl Survey in 2015-2018 in the third quarter (Q3). The error bars are estimated 95\% confidence intervals using the bias corrected (see Methods) and 200 bootstrap samples. The age of cod ranged from $1$ to $10+$ in the first quarter and $0$ to $10+$ in the third quarter, where $6+$ is the "plus group consisting of all fish of age $10$ and older.  }
\label{SaitheAreaHaulEstimatesAllYearsQ3}
\end{figure*} 
...
%\centering
%\begin{tabular}{@{}ccc@{}}
%\subfloat[cod in year 2015 Q1 and Q3]{\includegraphics[width=0.5\textwidth]{figures/AreaHaul2015.jpeg}} & 
%\subfloat[cod in year 2016 Q1 and Q3]{\includegraphics[width=0.5\textwidth]{figures/AreaHaul2016.jpeg}} & \\
%\subfloat[cod in year 2017 Q1 and Q3]{\includegraphics[width=0.5\textwidth]{figures/AreaHaul2017.jpeg}} & 
%\subfloat[cod in year 2018 Q1 and Q3]{\includegraphics[width=0.5\textwidth]{figures/AreaHaul2018.jpeg}} & 
%\end{tabular}
%\caption[]{Expected relative standard error (RSE) for estimated abundance-at-age for North Sea IBTS cod. The area based age-length key (ALK) of ICES is compared with the haul based ALK in the years 2015-2018 in quarters 1 and 3. The age of cod ranged from $1$ to $6+$ in the first quarter and $0$ to $6+$ in the third quarter, where $6+$ is the "plus group consisting of all fish of age $6$ and older.  }
%\label{AreaHaulAllYearsQ1}
%\end{figure*} 
...
%\centering
%\begin{tabular}{@{}ccc@{}}
%\subfloat[cod in year 2018 Q1]{\includegraphics[width=0.95\textwidth]{figures/CodCombinedQ12018.jpeg}} & \\
...
\centering
\begin{tabular}{@{}ccc@{}}
\subfloat[cod in year 2015 Q1]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulAreaMod2015.jpeg}} & 
\subfloat[cod in year 2016 Q1]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulAreaMod2016.jpeg}} & \\
\subfloat[cod in year 2017 Q1]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulAreaMod2017.jpeg}} & 
\subfloat[cod in year 2018 Q1]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulAreaMod2018.jpeg}} & 
\end{tabular}
\caption[]{Expected relative standard error (RSE) for estimated abundance at age (mCPUE) for North Sea IBTS cod in years 2015-2018 in the first quarter (Q1). The ICES-IBTS bootstrap procedure is compared with the modified ICES-IBTS and stratified bootstrap procedures. The ICES-IBTS bootstrap procedures are applied to area based age-length key (ALK) and the stratified bootstrap procedure. The age of cod ranged from $1$ to $6+$ in the first quarter and $0$ to $6+$ in the third quarter, where $6+$ is the "plus group consisting of all fish of age $6$ and older.}
...
\centering
\begin{tabular}{@{}ccc@{}}
\subfloat[saithe in year 2015 Q3]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulAreaMod2015Q3.jpeg}} & 
\subfloat[saithe in year 2016 Q3]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulAreaMod2016Q3.jpeg}} & \\
\subfloat[saithe in year 2017 Q3]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulAreaMod2017Q3.jpeg}} & 
\subfloat[saithe in year 2018 Q3]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulAreaMod2018Q3.jpeg}} & 
\end{tabular}
\caption[]{Expected relative standard error (RSE) for estimated abundance at age (mCPUE) for North Sea IBTS saithe in years 2015-2018 in the third quarter (Q3). The ICES-IBTS bootstrap procedure is compared with the modified ICES-IBTS and stratified bootstrap procedures. The ICES-IBTS bootstrap procedures are applied to area based age-length key (ALK) and the stratified bootstrap procedure. The age of cod ranged from $1$ to $10+$ in the first quarter and $0$ to $10+$ in the third quarter, where $10+$ is the "plus group consisting of all fish of age $10$ and older.}
\label{AreaAreaModAllYearsQ1}
\end{figure*} 

 \subsection{Comparison of the ALKs with an assessment study}
 In this section we compare the ALK procedures by investigating how the estimated spawning stock biomass (SSB) differs in an assessment study. We use the stock assessment model SAM \citep{nielsen2014estimation}, which is currently used in assessment for both the species in our case study. The default configurations in SAM are used. %We estimate the assessment model using indices calculated with area based ALK and hauls based ALKs. 
The estimated SSBs with usage of the two different ALKs are illustrated in Figure \ref{fig:assessment} for both cod and saithe. The differences in the estimated SSB between the two ALK procedures are marginal. Note that only the point estimates of the indices are used in the assessment study. Data needed for assessment, including the year range for the indices, are extracted from \href{www.stockassessment.org}{www.stockassessment.org}.  \olav{(we should include the CV in the assessment modelling, and use the same configurations as in the real assessment (\ed{what are these configurations, give example?}) --- \ed{use RSE-relative standard error instead of CV to be consistent in the paper?}---  \ed{perhaps we should be consistent with the years used in the paper (2015-2018)?})} 
 
 \begin{figure*}[h!]
\centering
\begin{tabular}{@{}ccc@{}}
\subfloat[]{\includegraphics[width=0.5\textwidth]{figures/SAMsaitheSSB.jpeg}} & 
\subfloat[]{\includegraphics[width=0.5\textwidth]{figures/SAMCodSSB.jpeg}} & \\\end{tabular}
...
%1) a haul based ALK that produces an ALK for each trawl haul, and which uses the raw proportions of age given length, and 2) a spatial ALK model that uses logits for modelling the age distribution in catch data from the length-stratified  subsamples.
...
From 1991-2017, most countries conducted quota sampling of otoliths per length group in a RFA. But from 2013, Norway has been sampling one otolith per length class from each trawl haul. From 2018 Q1, all countries are required to sample one otolith per length class per trawl haul.  Table \ref{tab:otolithsTable} gives the minimum sampling levels of otoliths for the target species.\\ %However, for the smallest size groups, that presumably contain only one age group, the number of otoliths per length class may be reduced, and more otoliths per length are required for the larger length classes.\\ %\\
%\clearpage
\begin{small}
\begin{table}[h!]
\centering
...
\centering
\begin{tabular}{@{}ccc@{}}
\subfloat[cod in year 2015 Q3]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulEstimates2015Q3.jpeg}} & 
\subfloat[cod in year 2016 Q3]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulEstimates2016Q3.jpeg}} & \\
\subfloat[cod in year 2017 Q3]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulEstimates2017Q3.jpeg}} & 
\subfloat[cod in year 2018 Q3]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulEstimates2018Q3.jpeg}} & 
\end{tabular}
\caption[]{Estimated abundance at age for North Sea cod for the two ALK estimators based on data from the International Bottom Trawl Survey in 2015-2018 in the third quarter (Q3). The error basrs are estimated 95\% confidence intervals using the bias corrected (see Methods) and 200 bootstrap samples.  }
...
\centering
\begin{tabular}{@{}ccc@{}}
\subfloat[saithe in year 2015 Q1 ]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulEstimates2015Q1.jpeg}} & 
\subfloat[saithe in year 2016 Q1 ]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulEstimates2016Q1.jpeg}} & \\
%\subfloat[saithe in year 2017 Q1]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulEstimates2017Q1.jpeg}} & 
\subfloat[saithe in year 2018 Q1]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulEstimates2018Q1.jpeg}} & 
\end{tabular}
\caption[]{Estimated abundance at age of North Sea saithe by the area based ALK and haul based ALK estimators based on data from the International Bottom Trawl Survey in 2015-2018 in the first quarter (Q1). The error bars are estimated 95\% confidence intervals using the bias corrected (see Methods) and 200 bootstrap samples. The age of cod ranged from $1$ to $10+$ in the first quarter and $0$ to $10+$ in the third quarter, where $6+$ is the "plus group consisting of all fish of age $6$ and older.  }
...
\centering
\begin{tabular}{@{}ccc@{}}
\subfloat[cod in year 2015 Q3]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulAreaMod2015Q3.jpeg}} & 
\subfloat[cod in year 2016 Q3]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulAreaMod2016Q3.jpeg}} & \\
\subfloat[cod in year 2017 Q3]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulAreaMod2017Q3.jpeg}} & 
\subfloat[cod in year 2018 Q3]{\includegraphics[width=0.5\textwidth]{figures/AreaHaulAreaMod2018Q3.jpeg}} & 
\end{tabular}
\caption[]{Expected relative standard error (RSE) for estimated abundance at age (mCPUE) for North Sea IBTS cod in years 2015-2018 in the third quarter (Q3). The ICES-IBTS bootstrap procedure is compared with the modified ICES-IBTS and stratified bootstrap procedures. The ICES-IBTS bootstrap procedures are applied to area based age-length key (ALK) and the stratified bootstrap procedure. The age of cod ranged from $1$ to $6+$ in the first quarter and $0$ to $6+$ in the third quarter, where $6+$ is the "plus group consisting of all fish of age $6$ and older.}
\label{AreaAreaModAllYearsQ3}
\end{figure*} 

\clearpage
Data is collected for 0-group saithe in 2016 Q1
\begin{figure*}[h!]
\centering
\begin{tabular}{@{}ccc@{}}
\subfloat[saithe in year 2015 Q1]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulAreaMod2015Q1.jpeg}} & 
\subfloat[saithe in year 2016 Q1]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulAreaMod2016Q1.jpeg}} & \\
%\subfloat[saithe in year 2017 Q1]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulAreaMod2017Q3.jpeg}} & 
\subfloat[saithe in year 2018 Q1]{\includegraphics[width=0.5\textwidth]{figures/SaitheAreaHaulAreaMod2018Q1.jpeg}} & 
\end{tabular}
