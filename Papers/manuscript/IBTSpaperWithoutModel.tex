...
\caption{Average number of otoliths sampled in length group widths: 5cm, 4cm,...,1cm (percentages are in parentheses). \textit{One} pair of otoliths are sampled in each length group width in the first quarter (Q1) in 2015-2018. The total number of otoliths sampled in a given year is also given.}\label{resamplingOtoliths2015-2018}}
\begin{footnotesize}
...
\caption{Average number of otoliths sampled in length group widths: 5cm, 4cm,...,1cm (percentages are in parentheses). \textit{One} pair of otoliths are sampled in each length group width in the third quarter in 2015-2018. The total number of otoliths sampled in a given year and quarter is also given.}\label{resamplingOtoliths2015-2018Q3}}
\begin{footnotesize}
\begin{tabular}{clclclclclclclclclclclclclclclclclclclclclclclclclclclclclclclclclcl}
  \hline \\ [0.3ex]
{\bf Year} &   \multicolumn{5}{c}{\bf Length group width  } & \thead{\bf Total otoliths }  \\[1.0ex]
