...
\ed{(we need to include a formula here that calculates the estimated unconditional probability in equation (\ref{eq:linearPred1}) if it is a conditional probability; see \citet{berg2012spatial})}
