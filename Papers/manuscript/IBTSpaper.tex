...
\captionsetup{font=small, width = 14.5cm}{
 \caption{Percentage relative standard error (RSE\%) and mean square errror (MSE) for age given specific length group sampling of otolith for cod in year 2018 Q1 and saithe in year 2017 Q3. }\label{fig:RSEandMSECodQ1}}
\end{figure}
