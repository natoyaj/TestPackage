...
\item Sample age observations from the resampled hauls in step 1 within each RFA stratified with respect to length and haul \olav{ using a pseudo-population bootstrap procedure \citep{mashreghi2016survey} (TODO)}. If there is only one observed age within a length group in a haul, that age is sampled.
\end{enumerate}
