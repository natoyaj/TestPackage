...
\end{equation}
where $p_a(l,s)$ is the probability of a fish with length $l$ at location ${\bf s}$ to be of age $a$. Note that either $p_{A}(l,{\bf s})$ or $p_{M}(l,{\bf s})$ is known to be equal to zero. We further assume the logit link
...
\centering
\begin{tabular}{@{}ccc@{}}
\subfloat[Cod in years 2017 Q3 and 2018 Q1]{\includegraphics[width=0.95\textwidth]{cod2017Q3BiasCorr.jpeg}} & \\
\subfloat[Percentile bootstrap method]{\includegraphics[width=0.95\textwidth]{cod2017Q3Percentile.jpeg}} &
\end{tabular}
\caption[]{Estimated confidence intervals ($\mathrm{CI}_{96}$) from bias-corrected  bootstrap method for cod in years 2017 Q3 and 2018 Q1. Estimated indices of abundance (Estimate), and its standard error (SE(Estimate), percentage relative standard error (RSE\%), and bootstrap mean (mean)  and median estimates are also given.}
...
\end{tabular}
\caption[]{Estimated confidence intervals ($\mathrm{CI}_{96}$)  from bias-corrected bootstrap method for saithe in year 2017 Q3. Estimated indices of abundance (Estimate), and its standard error (SE(Estimate)), bootstrap mean (mean) and median estimates are also given.}
...
% Fri Aug 24 11:42:15 2018
\begin{table}[ht]
\centering
\captionsetup{font=small, width = 16.5cm}{
\caption{Estimates of abundance indices of cod in year 2017 Q3.}\label{cod}}
